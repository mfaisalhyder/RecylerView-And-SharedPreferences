...
@SuppressLint("NewApi")
public class RecyclerAdapterFavourite extends RecyclerView.Adapter<RecyclerAdapterFavourite.ItemsViewHolder>{
	...
	public RecyclerAdapterFavourite(Context con, List<Word> wordsList){
